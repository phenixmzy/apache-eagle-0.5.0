...
public class HadoopFairQueueRunningApp extends StormApplication {
    public StormTopology execute(Config config, StormEnvironment environment) {
        ...
        StormStreamSink queueSinkBolt = environment.getStreamSink("HADOOP_FAIR_QUEUE_STREAM", config);
