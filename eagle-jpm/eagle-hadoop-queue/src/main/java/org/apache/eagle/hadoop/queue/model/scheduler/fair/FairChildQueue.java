...
public class FairChildQueue {
    ...
    private FairChildQueues childQueues;

    public FairChildQueues getChildQueues() {
        return childQueues;
    }

    public void setChildQueues(FairChildQueues childQueues) {
